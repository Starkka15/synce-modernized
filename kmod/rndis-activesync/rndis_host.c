...
static const struct usb_device_id	products [] = {
{
	...
	/* Dell Axim X50/X51 (WM6.x): interrupt poll causes EAGAIN, skip it */
	USB_DEVICE_AND_INTERFACE_INFO(0x413c, 0x4010, USB_CLASS_MISC, 1, 1),
	.driver_info = (unsigned long) &rndis_info,
}, {
	/* Dell Axim X51v */
	USB_DEVICE_AND_INTERFACE_INFO(0x413c, 0x4011, USB_CLASS_MISC, 1, 1),
	.driver_info = (unsigned long) &rndis_info,
}, {
